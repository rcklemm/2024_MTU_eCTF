#ifndef COMP_MESSAGING_H
#define COMP_MESSAGING_H
...
// Serialize and send the global transmit msg_t over I2C to the I2C master (AP)
...
// Receive and deserialize the global receive msg_t over I2C from the I2C master (AP)
